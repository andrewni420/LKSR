...
#ifndef  __GA_LINKERN_H
#define  __GA_LINKERN_H
...
int
    CCga_linkern_tour (int ncount, CCdatagroup *dat, int ecount,
        ...
        CCrandstate *rstate, ttpInstance *instance, ttpSolution *sol, 
        logisticRegressor *classifier, double *objective, int mode),
